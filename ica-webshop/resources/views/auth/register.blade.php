...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Hozz létre új fiókot') }}</div>
                ...
                <div class="card-body overflow">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Teljes név*') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">* Kötelező mező</div>
                        </div>
