...
<div class="container">
    <div class="card">
        <div class="card-header">
            {{ __('Rendelés részletes leírása') }}
        </div>
        <div class="card-body lead overflow">
            <div class="row">
                <div class="col-8">
                    <h1>Rendelés részletes leírása: <span class="text-muted">{{ $order->public_id }}</span></h1>
                </div>
                <div class="col-4 text-end">
                    <a href="{{ route('orders.myorders') }}" class="btn btn-primary">Vissza</a>
                </div>
            </div>
            @if($transferPayment)
                <div id="transfer-payment" class="alert alert-info" role="alert">
                    <span>A rendelést csak utalás után dolgozzuk fel.</span>
                </div>
            @endif
            <div class="row m-3">
